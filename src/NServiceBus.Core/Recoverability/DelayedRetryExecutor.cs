namespace NServiceBus
{
    ...
    class DelayedRetryExecutor
    {
        ...
        public async Task<int> Retry(IncomingMessage message, TimeSpan delay, TransportTransaction transportTransaction, CancellationToken token)
        {
            ...
            await dispatcher.Dispatch(transportOperations, transportTransaction, new ContextBag(), token).ConfigureAwait(false);
